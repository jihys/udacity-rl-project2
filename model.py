...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, actor_bn1, actor_bn2, custom_init,fc1_units=256, fc2_units=128):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed,critic_bn1, critic_bn2,custom_init, fcs1_units=256, fc2_units=128,):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
